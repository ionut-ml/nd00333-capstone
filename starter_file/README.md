...
Next, the input data was converted to json format (using "column-name": "value" format" of the 13 features) similar to the above documentation guidelines. Please see below screenshot for this as well as the set-up for the call (to be explained below):
